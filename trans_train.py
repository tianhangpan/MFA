...
from utils.trans_trainer import TransTrainer
...
parser.add_argument('save_path', metavar='SP', help='directory to save')
parser.add_argument('pth_path', metavar='PTH', help='the path to model')
