...
from utils.pre_tester import PreTester
...
parser.add_argument('-gn', '--gen_npy', metavar='GN', type=str, help='the path to save counts file', default='None')
